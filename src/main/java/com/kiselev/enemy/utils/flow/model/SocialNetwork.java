...
public enum SocialNetwork {
    ...
    TG("[%s](https://t.me/%s)", Pattern.compile("^((https?://)?(www\\.)?t\\.me/)([\\S&&[^?]]+)(\\?.+)?$")),
    IG("[%s](https://instagram.com/%s)", Pattern.compile("^((https?://)?(www\\.)?instagram\\.com/)([\\S&&[^?]]+)(\\?.+)?$")),
    VK("[%s](https://vk.com/%s)", Pattern.compile("^((https?://)?(www\\.)?vk\\.com/)(id\\d+|[\\S&&[^?]]+)(\\?.+)?$")),
